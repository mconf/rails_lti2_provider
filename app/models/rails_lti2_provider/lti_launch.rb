...
module RailsLti2Provider
  class LtiLaunch < ActiveRecord::Base
    ...
    def self.check_launch(lti_message)
      ...
      raise Unauthorized.new(:invalid_signature) unless IMS::LTI::Services::MessageAuthenticator.new(lti_message.launch_url, lti_message.post_params, tool.shared_secret)
